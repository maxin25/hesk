...
$hesklang['cat_intro']='Aquí puedes gestionar las categorías. Las categorías son útiles
para categorizar los tickets por relevancia (por ejemplo &quot;Ventas&quot;,
&quot;Problemas de hardware&quot;, &quot;Problemas de PHP/MySQL&quot; etc) y para
asignar usuarios a las categorías.';
$hesklang['spam_req']='¡Al menos una medida de prevención de SPAM debe estar activada!';
...
$hesklang['view_your_ticket']='Ver tu ticket';
...
$hesklang['kb_e_subj']='¡Ingrese asunto del art&iacute;culo!';
...
$hesklang['rh']='Calificado como útil';
$hesklang['rnh']='Calificado como poco útil';
...
$hesklang['opt4']='Opciones para esta casilla, introducir una opción por línea. Cada línea será una opción que los clientes pueden elegir, son posibles múltiples opciones.';
...
$hesklang['s_inle']='Comprobación de la carpeta de idiomas para ver si son válidos. Sólo se instalan correctamente los idiomas que superan todas las pruebas.';
$hesklang['beta']='(VERSIÓN DE PRUEBA)';
$hesklang['maxpost']='Probablemente has intentado enviar más datos de los que este servidor acepta.<br /><br />Por favor, intente enviar el formulario de nuevo con menos datos o sin ellos.';
...
$hesklang['nti3']='Utilice este formulario para crear un nuevo ticket en un nombre del cliente. Introduzca la informaci&oacute;n del <i>cliente</i> en el formulario (nombre de cliente, el correo electr&oacute;nico, ...) y NO su nombre! El Ticket ser&aacute; creado como si fuera enviado por el propio cliente.';
...
$hesklang['admin_login']='¡Bienvenido! Por favor, inicia sesión.';
...
$hesklang['thist15']='<li class="smaller">%s | anviado por %s</li>'; // %s = date, user making change
$hesklang['thist16']='<li class="smaller">%s | enviado por correo electronico POP3</li>';
...
$hesklang['emp']='Tu PHP no tiene habilitado el soporte de MySQL (se requiere la extensión mysqli)';
...
$hesklang['etfm']='Faltan una o más plantillas de correo electrónico.<br>Asegúrese de cargar todos los archivos de plantillas de correo electrónico dentro de tu carpeta<i>/language/%s/emails</i>.';
$hesklang['etfw']='Algunas plantillas de correo electrónico no son editables.<br>
                    Asegúrate de que PHP tiene permiso para escribir en todos los archivos dentro de tu carpeta<i>/language/%s/emails</i>.<br>
...
$hesklang['status_custom_none']='No hay estados personalizados. Puedes añadirlos haciendo clic en "Nuevo estado personalizado" arriba.';
...
$hesklang['hni3']='Para instalar HESK, sigue las <a class="link" href="docs/">Instructions in the documentationInstrucciones en la documentación</a>';
...
$hesklang['reset_your_password']='Restablecer tu contraseña';
$hesklang['reset_password_instructions']='Por favor, rellena el siguiente formulario. Te enviaremos un enlace para que puedas restablecer tu contraseña.';
$hesklang['enter_email']='Introduce el correo electrónico';
$hesklang['password_reset_check_your_email']='Comprueba tu correo electrónico';
$hesklang['password_reset_link_sent']='Te hemos enviado un enlace para restablecer tu contraseña.';
...
$hesklang['type_your_message']='Escribe su mensaje'; // Used when there are no canned responses
$hesklang['type_your_message_or_reply_from_template']='Escribe tu mensaje o %s'; // %s: "reply from template" (see $hesklang['reply_from_template'])
$hesklang['reply_from_template']='respuesta de plantilla'; // See $hesklang['type_your_message_or_reply_from_template'] for usage
...
$hesklang['confirm_delete_status']='¿Estás seguro de que quieres borrar este estado personalizado?';
...
$hesklang['lwidtall']='Utilizar todo el ancho disponible';
...
$hesklang['statistics']['resolved']='Resurltos';
...
$hesklang['statistics']['chart_title_ttr']='Ttiempo que transcurre entre la solicitud y la resolución de un ticket';
...
$hesklang['escalate']['no_rules']='No tiene ninguna regla de escalamiento. Cree una haciendo clic en el botón &quot;Nueva regla de escalamiento&quot; de arriba.';
...
$hesklang['escalate']['tall']='Aplicar esta regla a los billetes existentes y futuros';
...
$hesklang['escalate']['tbef']='Antes de que una regla esté activa, debe activarla haciendo clic en la casilla de verificación de la columna &quot;ACTIVAR&quot;.<br><br>
                               Recomendamos encarecidamente que <strong>simules</strong> cada regla haciendo clic en el icono %1$s (Simular esta regla) en la tabla de reglas
...
$hesklang['due_date_updated']='Se ha actualizado la fecha de vencimiento del billete.';
...
$hesklang['ql_due']='Próximo a vencer';
...
$hesklang['ntoverdue']='Un ticket está atrasado con el titular:';
$hesklang['ovdcron']='para que las notificaciones de vencimiento funcionen, tu administrador debe habilitar un trabajo cron.';
$hesklang['instructions']='Instrucciones';
$hesklang['desc_overdue_ticket']='(Personal) Ticket atrasado';
$hesklang['overdue_starting']='Inicio del proceso de notificación de billetes atrasados';
...
$hesklang['chg_cat']='Clic para cambiar la categoría del ticket';
...
$hesklang['flood']='Límite de inundación';
$hesklang['e_flood']='Ooops, ya has enviado una respuesta hace poco. Hemos detenido esta solicitud para evitar la inundación de respuestas.';
...
$hesklang['ukeym']='Error: para ejecutar este archivo a través de HTTP debes incluir tu clave de acceso a la URL en la solicitud. Ejemplo::';
